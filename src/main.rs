use rainbow_wrapper::{add, chunks::Type, instructions::Instruction, je, jge, nop, number, var, Data, Wrapper};
...
pub fn main() {
    ...
    test.module_begin("test".to_string());
        ...
        test.struct_start("testStruct2".to_string());
            
            test.add_var(Type::U8, "a".to_string(), Some(Data::Number(number!(u8 32))));
            test.add_var(Type::U8, "b".to_string(), Some(Data::Number(number!(u8 32))));
    ...
    //     test.add_instruction(nop!());
    //
    //     test.add_instruction(var!(Type::I32;       "i32Test"));
    //     test.add_instruction(var!(Type::UXX(31);   "uXXTest"));
    //     test.add_instruction(var!(Type::IXX(2);    "iXXTest"));
    //     test.add_instruction(var!(Type::FXX(1, 0); "fXXTest"));
    //
